...
class PongData {
  ...
  /// A factory constructor that creates a [PongData] instance from a list of bytes.
  factory PongData.fromBytes(List<int> bytes) {
    ...
    return PongData(isOnline: false);
  }

  /// A method that returns a string representation of the [PongData] instance.
  @override
  String toString() {
